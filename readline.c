...
int	main()
{
 ...
 //    }
	...
	tokenise(exmp4);
	tokenise(exmp5);
	print_tokens(ft_split(exmp, '#'));
	print_tokens(ft_split(exmp2, '#'));
	print_tokens(ft_split(exmp3, '#'));
	print_tokens(ft_split(exmp4, '#'));
	print_tokens(ft_split(exmp5, '#'));
